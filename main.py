...
save_to_mat("../project/xref_4.mat", t[:len(t)-Npred], xref[:, :len(t)-Npred], "x_ref")
save_to_mat("../project/uref_4.mat", t[:len(t)-Npred], uref[:, :len(t)-Npred], "u_ref")
save_to_mat("../project/xsim_4.mat", t[:len(t)-Npred], xsim[:, :len(t)-Npred], "xsim")
save_to_mat("../project/usim_4.mat", t[:len(t)-Npred], usim[:, :len(t)-Npred], "usim")
save_to_mat("../project/lin_x_4.mat", t[:len(t)-Npred], lin_response, "lin_x")
